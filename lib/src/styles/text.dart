...
abstract class TextStyles {
  ...
  static TextStyle get listTitle1 {
    return GoogleFonts.poppins(
        textStyle: TextStyle(
            color: AppColors.darkblue,
            fontWeight: FontWeight.bold,
  ...
  static TextStyle get body {
    return GoogleFonts.roboto(
        textStyle: TextStyle(color: AppColors.darkgray, fontSize: 16.0,fontWeight: FontWeight.bold));
  }

  static TextStyle get body1 {
    return GoogleFonts.poppins(
        textStyle: TextStyle(color: AppColors.darkgray, fontSize: 14.0,fontWeight: FontWeight.bold));
  }
