    ...
    return ListView(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(image: AssetImage('assets/images/FarmersLogo.jpg')),
          ),
        ),
     StreamBuilder<String>(
        ...
        SizedBox(height: 6.0,),
        Center(child: Text('or',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20.0,color:AppColors.darkblue),),),
        SizedBox(height: 6.0,),
        Padding(
        ...
        Padding( 
          ...
          child: RichText( 
            ...
            text: TextSpan(  
              ...
              style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18.0,color:AppColors.darkblue),
              children: [ 
                TextSpan(  
                  text: 'Login',
                  style:TextStyle(fontWeight: FontWeight.bold,fontSize: 20.0,color:AppColors.straw),
