...
class ProductBloc {
  ...
  final _marketId = BehaviorSubject<String>();
  ...
  Stream<String> get marketID => _marketId.stream;
  ...
  Stream<bool> get isValid => CombineLatestStream.combine4(
      productName, marketID, unitPrice, availableUnits, (a, b, c, d) => true);
  ...
  Function(String) get changemarketId => _marketId.sink.add;
