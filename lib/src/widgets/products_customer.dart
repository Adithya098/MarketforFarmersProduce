                        ...
                        return Column(
                          children: [
                            ListTile(
                              ...
                              subtitle: Text('The Vendor Name',style: TextStyle(fontWeight: FontWeight.bold)),
                              trailing: Text('\u{20B9}${' '}${product.unitPrice}${' / kg'}',style:TextStyle(fontWeight: FontWeight.bold,color:AppColors.green,fontSize:17.0)),
                            ),
