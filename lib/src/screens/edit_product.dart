...
class _EditProductState extends State<EditProduct> {
  ...
  Widget pageBody(bool isIOS, ProductBloc productBloc, BuildContext context,
    ...
    return ListView(
      children: <Widget>[
        ...
        StreamBuilder<String>(
            ...
            builder: (context, snapshot) {
              return AppTextField(
                ...
                cupertinoIcon: FontAwesomeIcons.shoppingCart,
                materialIcon: FontAwesomeIcons.shoppingCart,
                isIOS: isIOS,
        ...
        StreamBuilder<String>(
            stream: productBloc.marketID,
            builder: (context, snapshot) {
              return AppTextField(
                hintText: 'Market ID',
                cupertinoIcon: FontAwesomeIcons.idBadge,
                materialIcon: FontAwesomeIcons.idBadge,
                isIOS: isIOS,
                textInputType: TextInputType.number,
                errorText: snapshot.error,
                onChanged: productBloc.changemarketId,
              );
            }),
  ...
  loadValues(ProductBloc productBloc, Product product, String vendorId) {
    ...
    if (product != null) {
      //Edit
      productBloc.changemarketId(product.marketId);
      ...
      //Add
      productBloc.changemarketId(null);
